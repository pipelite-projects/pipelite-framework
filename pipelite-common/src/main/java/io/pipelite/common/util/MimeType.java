package io.pipelite.common.util;
...
public class MimeType implements Comparable<MimeType>, Serializable {
    ...
    public MimeType(String type, String subtype,  Map<String, String> parameters) {
        Preconditions.hasText(type, "'type' must not be empty");
        Preconditions.hasText(subtype, "'subtype' must not be empty");
        checkToken(type);
        checkToken(subtype);
    ...
    protected void checkParameters(String parameter, String value) {
        Preconditions.hasText(parameter, "'parameter' must not be empty");
        Preconditions.hasText(value, "'value' must not be empty");
    ...
    public boolean isMoreSpecific(MimeType other) {
        Preconditions.notNull(other, "Other must not be null");
