...
public class TimeService extends ScheduledPollingConsumerService
    implements ExchangeFactoryAware {

    public TimeService(TimePollingConsumer pollingConsumer, ScheduledExecutorService consumerPool) {
