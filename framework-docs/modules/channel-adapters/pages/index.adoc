...
Each line is a `scheme=fully.qualified.ClassName` entry (e.g. `http=io.pipelite.components.http.HttpChannelAdapter`).
The framework loads the classes at context startup.
