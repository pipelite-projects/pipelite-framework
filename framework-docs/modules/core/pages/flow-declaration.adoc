...
<2> The framework instantiates the class via its default constructor and invokes each `@DefineFlow` method.
...
* By type — the registry checks assignability across all registered instances.
